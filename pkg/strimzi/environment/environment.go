...
func GetENV(experimentDetails *experimentTypes.ExperimentDetails) {
	...
	experimentDetails.App.LivenessStreamCleanup = types.Getenv("LIVENESS_STREAM_CLEANUP","disable")
	...
	experimentDetails.Strimzi.InternalListenerPortNumber, _ = strconv.Atoi(types.Getenv("INTERNAL_STRIMZI_KAFKA_CLUSTER_LISTENER_PORT", "10001"))
	experimentDetails.Strimzi.InternalListenerName = types.Getenv("INTERNAL_STRIMZI_KAFKA_CLUSTER_LISTENER_NAME", "litlis")
